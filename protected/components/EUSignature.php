...
class EUSignature
{
    ...
    public $sSubjDRFOCode="";	//* Вихідний. ДРФО код.
				// Передається за посиланням
    public $sResultData="";	//* Вихідний. Перевірені дані.
				// Передається за посиланням
    ...
    public function check($need_for_utf8 = true, $need_convert_data_from_utf16 = true)
    {
	$i1 = 0;
	euspe_init($i1);
	$s1 = "";
...
//$i = euspe_signverify($sData, $sSignTime, $bUseTSP, $sIssuer, $sIssuerCN, $sSerial, $sSubject, $sSubjCN, $sSubjOrg, $sSubjOrgUnit, $sSubjTitle, $sSubjState, $sSubjLocality, $sSubjFullName, $sSubjAddress, $sSubjPhone, $sSubjEmail, $sSubjDNS, $sSubjEDRPOUCode, $sSubjDRFOCode, $sResultData, $iErrorCode);
	$i1 = euspe_signverify($this->Signature, $this->sSignTime, $this->bUseTSP, $this->sIssuer, $this->sIssuerCN, $this->sSerial, $this->sSubject, $this->sSubjCN, $this->sSubjOrg, $this->sSubjOrgUnit, $this->sSubjTitle, $this->sSubjState, $this->sSubjLocality, $this->sSubjFullName, $this->sSubjAddress, $this->sSubjPhone, $this->sSubjEmail, $this->sSubjDNS, $this->sSubjEDRPOUCode, $this->sSubjDRFOCode, $this->sResultData, $this->iErrorCode);
	$s1="";
