...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('is_cnap')); ?>:</b>
	<?php echo CHtml::encode($data->is_cnap); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('working_time')); ?>:</b>
	<?php echo CHtml::encode($data->working_time); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('gpscoordinates')); ?>:</b>
	<?php echo CHtml::encode($data->gpscoordinates); ?>
	<br />
