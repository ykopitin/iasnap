...
?>
<h1>Авторизація операторів порталу</h1>
...
<?php
    $this->Widget('application.components.EUWidget.EUWidget', array('WidgetType'=>'Login', 'WidgetAction'=>'/admin/signAdm/login', 'model'=>$model));
?>
