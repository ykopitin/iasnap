...
/**
 * This is the model class for table "gen_serv_classes".
 *
 * The followings are the available columns in table 'gen_serv_classes':
 * @property integer $id
...
class GenServClasses extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, item_name, visability', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return GenServClasses the static model class
	 */
