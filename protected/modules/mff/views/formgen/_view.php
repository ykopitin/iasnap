...
echo "<td>";
    $chield_img = CHtml::image($this->createUrl("default/getimage",array("image"=>"Arrow_down")),"Потомки",array("style"=>"width:24px"));
    $edit_img = CHtml::image($this->createUrl("default/getimage",array("image"=>"Pencil")),"Изменить",array("style"=>"width:24px"));
    $delete_img = CHtml::image($this->createUrl("default/getimage",array("image"=>"Minus")),"Удалить",array("style"=>"width:24px"));
    $add_img = CHtml::image($this->createUrl("default/getimage",array("image"=>"Plus")),"Добавить потомка",array("style"=>"width:24px"));
