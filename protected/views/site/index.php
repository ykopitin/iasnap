...
«<?php echo CHtml::link(GenServClasses::model()->findByPk('2')->item_name, array('serv/?class=2'));?>» або 
«<?php echo CHtml::link(GenServClasses::model()->findByPk('1')->item_name, array('serv/?class=1'));?>». 
