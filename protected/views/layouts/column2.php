...
if ((isset($_GET['func']))|| $_SERVER['REQUEST_URI']==Yii::app()->baseUrl.'/' || $_SERVER['REQUEST_URI']==Yii::app()->baseUrl.'/index.php' || (isset($_GET['class']) && !isset($_GET['param']) && !isset($_GET['servid']))){ include 'mainmenu.php' ;}
