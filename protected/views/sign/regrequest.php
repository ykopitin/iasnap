...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->textField($model, 'activ_code',array('id'=>'activ_code','placeholder'=>'Код активації')); ?>
		<?php echo $form->error($model,'activ_code'); ?>
	</div>

	<div class="row buttons">
		<?php echo CHtml::submitButton('Продовжити',array('onclick'=>'return signd(); return false;')); ?>
	</div>
...
<script>
	function signd() {
		...
		euSign.width = "1px";
		euSign.SetUIMode(false);
		var tosign = document.getElementById("activ_code").value;
//		tosign="123321"+"";
...
//			alert(euSign.BytesToString(SignInfo.GetData()));
			euSign.Finalize();
			post('register2', {Signature: $signed_data});
