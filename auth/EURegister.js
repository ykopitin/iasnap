...
// (todo: перевірити функціонування параметру ProxySavePass)
...
//						Signature = euSign.SignInternal("true", Signature + ";" + Email + ";" + Phone + ";" + is_legal + ";" + legal_person);
alert("step002");
						Email = document.getElementById('Email');
						Phone = document.getElementById('Phone');

						Signature = euSign.SignInternal("true", Signature + ";" + Email + ";" + Phone);
alert("Signature:" + Signature + ";" + Email + ";" + Phone);						
...
//						document.getElementById('s5_edrpou').value = ownerInfo.GetSubjEDRPOUCode();
						document.getElementsByName('RegForm[Signature]')[0].value = Signature;
alert("step004");
