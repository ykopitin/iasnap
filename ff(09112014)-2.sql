...
AUTO_INCREMENT=148 AVG_ROW_LENGTH=112 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
#
# Data for the `ff_default` table  (LIMIT -353,500)
#
...
#
# Data for the `ff_oneline` table  (LIMIT -459,500)
#
...
INSERT INTO `ff_oneline` (`id`, `registry`, `storage`, `name`) VALUES
  ...
  (101,25,3,'До виконавця'),
  (104,26,3,'Відмовити'),
  (108,26,3,'Прийняті у роботу'),
  (110,26,3,'Видати документ'),
  (115,26,3,'Відмовити'),
  (120,26,3,'До архіву');
COMMIT;
...
#
# Data for the `ff_ref_multiguide` table  (LIMIT -401,500)
#
...
INSERT INTO `ff_ref_multiguide` (`id`, `registry`, `storage`, `order`, `owner`, `owner_field`, `reference`) VALUES
  ...
  (102,2,2,NULL,101,'gotonodes',46),
  (103,2,2,NULL,101,'roles',3),
  (105,2,2,NULL,104,'gotonodes',48),
  (106,2,2,NULL,104,'clearnodes',45),
  (107,2,2,NULL,104,'ownernodes',43),
  (109,2,2,NULL,108,'gotonodes',68),
  (111,2,2,NULL,110,'gotonodes',47),
  (112,2,2,NULL,110,'clearnodes',46),
  (113,2,2,1,110,'clearnodes',68),
  (114,2,2,NULL,110,'ownernodes',46),
  (116,2,2,NULL,115,'gotonodes',47),
  (117,2,2,NULL,115,'clearnodes',68),
  (118,2,2,NULL,115,'ownernodes',46),
  (119,2,2,1,115,'ownernodes',68),
  (121,2,2,NULL,120,'gotonodes',48),
  (122,2,2,NULL,120,'ownernodes',47),
  (123,2,2,NULL,43,'allow_action',94),
  (124,2,2,NULL,44,'allow_action',98),
  (125,2,2,NULL,44,'deny_action',94),
  (126,2,2,NULL,45,'allow_action',101),
  (127,2,2,1,45,'allow_action',104),
  (128,2,2,NULL,45,'deny_action',98),
  (129,2,2,NULL,46,'allow_action',108),
  (130,2,2,NULL,46,'deny_action',101),
  (131,2,2,1,46,'deny_action',104),
  (132,2,2,NULL,47,'allow_action',120),
  (133,2,2,NULL,47,'deny_action',94),
  (134,2,2,1,47,'deny_action',98),
  (135,2,2,2,47,'deny_action',101),
  (136,2,2,3,47,'deny_action',104),
  (137,2,2,4,47,'deny_action',108),
  (138,2,2,5,47,'deny_action',110),
  (139,2,2,6,47,'deny_action',115),
  (140,2,2,NULL,68,'allow_action',110),
  (141,2,2,1,68,'allow_action',115),
  (142,2,2,NULL,68,'deny_action',94),
  (143,2,2,1,68,'deny_action',98),
  (144,2,2,2,68,'deny_action',101),
  (145,2,2,3,68,'deny_action',104),
  (146,2,2,4,68,'deny_action',108),
  (147,2,2,5,68,'deny_action',120);
COMMIT;
...
INSERT INTO `ff_storage` (`id`, `name`, `description`, `subtype`, `type`, `fields`) VALUES
  ...
  (21,'Данние по сертификатам','Внешняя таблица с сертификатами пользователей',0,NULL,'');
COMMIT;
...
INSERT INTO `ff_route_action` (`id`, `registry`, `storage`, `name`, `comment`, `gotonodes`, `clearnodes`) VALUES
  ...
  (101,25,3,'До виконавця','Адміністратор ЦНАП набравляе документ на розгляд виконавцю',NULL,NULL),
  (104,26,3,'Відмовити','Адміністратор відмовляє заявникові у розгляді його заяви.',NULL,NULL),
  (108,26,3,'Прийняті у роботу','Виконавець бере до роботи документ надісланий Адміністратором ЦНАП',NULL,NULL),
  (110,26,3,'Видати документ','Виконавець надає позитивне рішення щодо поточного документа',NULL,NULL),
  (115,26,3,'Відмовити','Виконавець відмовляє у видачи документа',NULL,NULL),
  (120,26,3,'До архіву','Адміністратор направляє документ до архіву',NULL,NULL);
COMMIT;

#
# Data for the `ff_route_action_for_role` table  (LIMIT -496,500)
#
...
INSERT INTO `ff_route_action_for_role` (`id`, `registry`, `storage`, `name`, `comment`, `gotonodes`, `clearnodes`, `setroles`, `roles`, `currentrole`) VALUES
  ...
  (101,25,3,'До виконавця','Адміністратор ЦНАП набравляе документ на розгляд виконавцю',NULL,NULL,NULL,NULL,0);
COMMIT;

#
# Data for the `ff_route_action_for_user` table  (LIMIT -494,500)
#

INSERT INTO `ff_route_action_for_user` (`id`, `registry`, `storage`, `name`, `comment`, `gotonodes`, `clearnodes`, `users`, `currentuser`, `ownernodes`) VALUES

  (104,26,3,'Відмовити','Адміністратор відмовляє заявникові у розгляді його заяви.',NULL,NULL,NULL,1,NULL),
  (108,26,3,'Прийняті у роботу','Виконавець бере до роботи документ надісланий Адміністратором ЦНАП',NULL,NULL,NULL,1,NULL),
  (110,26,3,'Видати документ','Виконавець надає позитивне рішення щодо поточного документа',NULL,NULL,NULL,1,NULL),
  (115,26,3,'Відмовити','Виконавець відмовляє у видачи документа',NULL,NULL,NULL,1,NULL),
  (120,26,3,'До архіву','Адміністратор направляє документ до архіву',NULL,NULL,NULL,0,NULL);
COMMIT;
