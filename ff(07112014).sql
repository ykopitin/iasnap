...
AVG_ROW_LENGTH=109 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AVG_ROW_LENGTH=104 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=998 AVG_ROW_LENGTH=55 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AVG_ROW_LENGTH=252 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
CREATE TABLE `ff_document_cnap` (
  ...
  `phone1` VARCHAR(255) COLLATE utf8_general_ci DEFAULT NULL,
...
AVG_ROW_LENGTH=224 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=38 AVG_ROW_LENGTH=528 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AUTO_INCREMENT=246 AVG_ROW_LENGTH=98 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AVG_ROW_LENGTH=341 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=130 AVG_ROW_LENGTH=186 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AUTO_INCREMENT=59 AVG_ROW_LENGTH=528 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AUTO_INCREMENT=1019 AVG_ROW_LENGTH=512 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
#
# Data for the `ff_available_nodes` table  (LIMIT -336,500)
#
...
#
# Data for the `ff_default` table  (LIMIT 434,500)
#
...
#
# Data for the `ff_document_base` table  (LIMIT -434,500)
#

INSERT INTO `ff_document_base` (`id`, `registry`, `storage`, `createdate`, `route`, `nodes`, `available_nodes`, `available_actions`) VALUES

  (16,14,8,'2014-11-07 17:34:16',NULL,NULL,NULL,NULL),
  (145,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (146,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (147,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (148,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (149,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (150,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (151,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (152,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (153,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (154,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (157,14,8,'2014-11-07 17:34:16',NULL,NULL,NULL,NULL),
  (159,14,8,'2014-11-07 17:34:16',NULL,NULL,NULL,NULL),
  (160,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (162,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (164,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (179,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (210,24,8,'2014-11-07 17:34:16',NULL,NULL,NULL,NULL),
  (213,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (215,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (218,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (222,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (225,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (232,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (256,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (335,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (668,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (704,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (738,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (766,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (771,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (776,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (781,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (782,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (783,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (788,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (813,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (848,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (853,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (858,14,8,'2014-11-07 17:34:16',211,NULL,NULL,NULL),
  (861,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (866,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (871,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (876,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (881,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (886,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (891,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (896,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (901,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (911,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (921,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (926,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (931,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (936,14,8,'2014-11-07 17:34:16',211,NULL,NULL,NULL),
  (939,14,8,'2014-11-07 17:34:16',211,NULL,NULL,NULL),
  (942,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (947,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (952,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (957,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (962,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (967,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (972,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (977,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (982,14,8,'2014-11-07 17:34:16',21,NULL,NULL,NULL),
  (994,36,16,'2014-11-07 20:47:06',NULL,NULL,NULL,NULL);
COMMIT;

#
# Data for the `ff_document_cnap` table  (LIMIT -498,500)
#
...
INSERT INTO `ff_document_cnap` (`id`, `registry`, `storage`, `createdate`, `route`, `available_nodes`, `available_actions`, `regnum`, `regdate`, `legal_personality`, `organization`, `person_name`, `person_drfo`, `address`, `phone1`, `phone2`, `delivery_reply`, `email`, `service`, `context`, `reason`, `reply`, `file_petition`, `file_petition_fileedsname`, `plandate`, `factdate`, `administrator`, `executor`, `file_result`, `file_result_fileedsname`) VALUES
  ...
  (994,36,16,'2014-11-07 20:47:06',NULL,NULL,NULL,NULL,NULL,NULL,993,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
COMMIT;

#
# Data for the `ff_document_demo` table  (LIMIT -420,500)
#
...
#
# Data for the `ff_registry` table  (LIMIT -468,500)
#
...
#
# Data for the `ff_field` table  (LIMIT -332,500)
#
...
INSERT INTO `ff_field` (`id`, `formid`, `name`, `type`, `description`, `order`, `protected`, `default`) VALUES
  ...
  (76,13,'createdate',17,'Время создания документа',0,0,'CURRENT_TIMESTAMP'),
  (77,14,'registry',2,NULL,0,1,NULL),
  (78,14,'storage',2,NULL,0,1,NULL),
  (79,14,'createdate',17,'Время создания документа',0,1,''),
  ...
  (143,24,'createdate',17,'Время создания документа',0,1,''),
  ...
  (212,36,'createdate',17,'Время создания документа',0,1,'CURRENT_TIMESTAMP'),
  (213,36,'route',1003,'Маршрут',0,1,''),
  ...
  (217,36,'regnum',1,'Реєстраційний номер',100,0,''),
  (218,36,'regdate',3,'Дата реєстрації',200,0,''),
  (219,36,'legal_personality',1014,'Правова форма',300,0,''),
  (220,37,'registry',2,NULL,0,1,NULL),
  (221,37,'storage',2,NULL,0,1,NULL),
  (222,37,'name',1,'Наименование',100,1,NULL),
  (223,37,'edrpou',1,'ЄДРПОУ',0,0,''),
  (224,36,'organization',1016,'Підприємство',400,0,''),
  (225,36,'person_name',1,'Им''я фізичної особи',500,0,''),
  (226,36,'person_drfo',1,'Код ДРФО',600,0,''),
  (227,36,'address',4,'Адреса',700,0,''),
  (228,36,'phone1',1,'Телефон 1',800,0,''),
  (229,36,'phone2',1,'Телефон 2',900,0,''),
  (230,36,'delivery_reply',1017,'Форма надання відповіді',1000,0,''),
  (231,36,'email',1,'E-Mail',1100,0,''),
  (232,36,'service',1015,'Послуга',1200,0,''),
  (233,36,'tracknumber',8,'Трек-номер',1300,0,''),
  (234,36,'context',4,'Короткий зміст',1400,0,''),
  (235,36,'reason',4,'Висновок',1500,0,''),
  (236,36,'reply',1018,'Результат',1600,0,''),
  (237,36,'file_petition',14,'Заява',1700,0,''),
  (238,36,'file_petition_fileedsname',15,'Заява - Имя файла',0,1,''),
  (239,36,'initeds',13,'Java-аплет.',1,0,''),
  (240,36,'plandate',3,'Запланована дата виконання',1800,0,''),
  (241,36,'factdate',3,'Дата виконання',1900,0,''),
  (242,36,'administrator',2,'Администратор',2000,0,''),
  (243,36,'executor',2,'Виконавец',2100,0,''),
  (244,36,'file_result',14,'Результат рассмотрения',2200,0,''),
  (245,36,'file_result_fileedsname',15,'Результат рассмотрения - Имя файла',0,1,'');
COMMIT;

#
# Data for the `ff_oneline` table  (LIMIT -451,500)
#
...
INSERT INTO `ff_oneline` (`id`, `registry`, `storage`, `name`) VALUES
  ...
  (987,3,15,'Фізична особа'),
  (988,3,15,'Фізична особа - підприємець'),
  (989,3,15,'Юридична особа'),
  (990,3,20,'Відмовленно'),
  (991,3,20,'Рішення підписано'),
  (992,3,20,'Надан дозвіл'),
  (993,37,18,NULL),
  (995,3,19,'Сайт'),
  (996,3,19,'Пошта'),
  (997,3,19,'Особисто');
...
#
# Data for the `ff_organization` table  (LIMIT -498,500)
#
...
#
# Data for the `ff_ref_multiguide` table  (LIMIT -253,500)
#
...
INSERT INTO `ff_ref_multiguide` (`id`, `registry`, `storage`, `order`, `owner`, `owner_field`, `reference`) VALUES
  ...
  (786,2,2,NULL,783,119,784),
  (787,2,2,NULL,783,121,785),
  (807,2,2,NULL,788,119,801),
  (808,2,2,1,788,119,803),
  (809,2,2,2,788,119,805),
  (810,2,2,NULL,788,121,802),
  (811,2,2,1,788,121,804),
  (812,2,2,2,788,121,806),
  (842,2,2,NULL,813,119,836),
  (843,2,2,1,813,119,837),
  (844,2,2,2,813,119,839),
  (845,2,2,NULL,813,121,838),
  (846,2,2,1,813,121,840),
  (847,2,2,2,813,121,841),
  (851,2,2,NULL,848,119,849),
  (852,2,2,NULL,848,121,850),
  (856,2,2,NULL,853,119,854),
  (857,2,2,NULL,853,121,855),
  (860,2,2,NULL,858,119,859),
  (864,2,2,NULL,861,119,862),
  (865,2,2,NULL,861,121,863),
  (869,2,2,NULL,866,119,867),
  (870,2,2,NULL,866,121,868),
  (874,2,2,NULL,871,119,872),
  (875,2,2,NULL,871,121,873),
  (879,2,2,NULL,876,119,877),
  (880,2,2,NULL,876,121,878),
  (884,2,2,NULL,881,119,882),
  (885,2,2,NULL,881,121,883),
  (889,2,2,NULL,886,119,887),
  (890,2,2,NULL,886,121,888),
  (894,2,2,NULL,891,119,892),
  (895,2,2,NULL,891,121,893),
  (899,2,2,NULL,896,119,897),
  (900,2,2,NULL,896,121,898),
  (904,2,2,NULL,901,119,902),
  (905,2,2,NULL,901,121,903),
  (914,2,2,NULL,911,119,912),
  (915,2,2,NULL,911,121,913),
  (924,2,2,NULL,921,119,922),
  (925,2,2,NULL,921,121,923),
  (929,2,2,NULL,926,119,927),
  (930,2,2,NULL,926,121,928),
  (934,2,2,NULL,931,119,932),
  (935,2,2,NULL,931,121,933),
  (938,2,2,NULL,936,119,937),
  (941,2,2,NULL,939,119,940),
  (945,2,2,NULL,942,119,943),
  (946,2,2,NULL,942,121,944),
  (950,2,2,NULL,947,119,948),
  (951,2,2,NULL,947,121,949),
  (955,2,2,NULL,952,119,953),
  (956,2,2,NULL,952,121,954),
  (960,2,2,NULL,957,119,958),
  (961,2,2,NULL,957,121,959),
  (965,2,2,NULL,962,119,963),
  (966,2,2,NULL,962,121,964),
  (970,2,2,NULL,967,119,968),
  (971,2,2,NULL,967,121,969),
  (975,2,2,NULL,972,119,973),
  (976,2,2,NULL,972,121,974),
  (980,2,2,NULL,977,119,978),
  (981,2,2,NULL,977,121,979),
  (985,2,2,NULL,982,119,983),
  (986,2,2,NULL,982,121,984);
COMMIT;

#
# Data for the `ff_registry_h` table  (LIMIT -411,500)
#
...
INSERT INTO `ff_storage` (`id`, `name`, `description`, `subtype`, `type`, `fields`) VALUES
  ...
  (12,'Список регистраций свободных форм','Список зарегистрированых свободных форм',5,1011,NULL),
  (13,'Список хранилищ','Список зарегистрированных хранилищ',5,1012,NULL),
  (14,'Доступные действия','Перечень доступных действий в узле',5,1013,NULL),
  (15,'Правовая форма','Физик, Юрик',4,1014,NULL),
  (16,'Документы ЦНАП','Документы по получению админуслуг',0,NULL,NULL),
...
#
# Data for the `ff_registry_storage` table  (LIMIT -468,500)
#
...
#
# Data for the `ff_types` table  (LIMIT -467,500)
#
