...
AUTO_INCREMENT=277 AVG_ROW_LENGTH=89 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AUTO_INCREMENT=61 AVG_ROW_LENGTH=546 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
#
# Data for the `ff_field` table  (LIMIT -316,500)
#
...
INSERT INTO `ff_field` (`id`, `formid`, `name`, `type`, `description`, `order`, `protected`, `default`) VALUES
  ...
  (270,38,'initeds',13,'Java-аплет.',1,1,NULL),
