...
AUTO_INCREMENT=172 AVG_ROW_LENGTH=114 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AUTO_INCREMENT=21 AVG_ROW_LENGTH=963 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AUTO_INCREMENT=122 AVG_ROW_LENGTH=202 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AVG_ROW_LENGTH=240 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=62 AVG_ROW_LENGTH=364 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AUTO_INCREMENT=37 AVG_ROW_LENGTH=963 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
AUTO_INCREMENT=1013 AVG_ROW_LENGTH=862 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
...
#
# Data for the `ff_available_nodes` table  (LIMIT -496,500)
#
...
#
# Data for the `ff_default` table  (LIMIT -342,500)
#
...
#
# Data for the `ff_document_base` table  (LIMIT -473,500)
#
...
INSERT INTO `ff_document_base` (`id`, `registry`, `storage`, `createdate`, `route`, `nodes`, `available_nodes`, `available_actions`) VALUES 
  ...
  (169,14,8,NULL,21,NULL,NULL,NULL);
COMMIT;

#
# Data for the `ff_document_demo` table  (LIMIT -473,500)
#
...
#
# Data for the `ff_registry` table  (LIMIT -479,500)
#
...
#
# Data for the `ff_field` table  (LIMIT -418,500)
#
...
#
# Data for the `ff_oneline` table  (LIMIT -462,500)
#
...
#
# Data for the `ff_ref_multiguide` table  (LIMIT -428,500)
#
...
INSERT INTO `ff_ref_multiguide` (`id`, `registry`, `storage`, `order`, `owner`, `owner_field`, `reference`) VALUES 
  ...
  (141,2,2,NULL,95,59,22),
  (142,2,2,NULL,95,61,8),
  (143,2,2,NULL,95,62,8),
  (144,2,2,NULL,95,63,8),
  ...
  (171,2,2,NULL,169,119,170);
COMMIT;

#
# Data for the `ff_registry_h` table  (LIMIT -448,500)
#
...
#
# Data for the `ff_storage` table  (LIMIT -486,500)
#
...
#
# Data for the `ff_registry_storage` table  (LIMIT -482,500)
#
...
INSERT INTO `ff_route_folder` (`id`, `registry`, `storage`, `name`, `comment`, `nodes`, `allow_new`, `allow_edit`, `allow_delete`) VALUES 
  (95,8,6,'Новые','Вновь созданые заявления',NULL,NULL,NULL,NULL),
  (97,8,6,'Рассматриваются','Документы находящиеся на рассмотрении в ЦНАП',NULL,0,0,0),
  (99,8,6,'Рассмотреные заявления','Документы, решение по которым было вынесено',NULL,0,0,0),
  (105,8,6,'Поступившие','Документы, поступившие на рассмотрение администраторов',NULL,0,0,0),
  (107,8,6,'В работе','Документы, принятые на рассмотрение администратором',NULL,0,0,0),
  (109,8,6,'На рассмотрении','Документы, на рассмотрении у исполнительной службы',NULL,0,0,0),
  (111,8,6,'Архив','Документы положенные администратором в архив',NULL,0,0,0),
  (113,8,6,'Поступившие','Документы, поступившие в исполнительную службу',NULL,0,0,0),
  (115,8,6,'В работе','Документы принятые в работу представителем исполнительной службы',NULL,0,0,0),
  (117,8,6,'В ожидании оплаты','Документы, по которым вынесено положительное решение, но для выдачи разрешительного документа требуется оплата',NULL,0,0,0),
  (119,8,6,'Архив','Документы, помещеные администратором в архив',NULL,0,0,0);
COMMIT;
...
#
# Data for the `ff_types` table  (LIMIT -474,500)
#
